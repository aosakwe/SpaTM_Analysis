...
# scenarios <- list(list(train = c("151673"),test = c('151676','151507','151508'  ,'151509',
#                                 '151510',"151669",
#                                 "151670",
#                                 "151671",
#                                 "151672")),
#                   list(train = c("151673","151674","151675"),
#                        test = c('151676','151507','151508','151509',
#                                 '151510',"151669",
#                                 "151670",
#                                 "151671",
#                                 "151672")))
...
results <- matrix(0,nrow = (length(scenarios[[1]]$test) + length(scenarios[[2]]$test)),ncol = 2)
...
for(i in 1:2){#length(scenarios)){
  ...
  for(j in 1:length(scenarios[[i]]$test)){
    ...
    results[z,] <- test_res
    z <- z + 1
    print(vis_clus(spe_test,clustervar = 'spatialLIBD'))
    print(vis_clus(spe_test,clustervar = 'smooth'))
   if (j == 1){
      in_spe <- spe_test
    } else if (j == 2){
      cross_spe <- spe_test
...
# table(keep.genes == rownames(temp))
# rownames(temp) <- results$hgnc_symbol
# phi(spe_train) <- temp
rownames(phi(spe_train)) <- rowData(spe_train)$gene_name
